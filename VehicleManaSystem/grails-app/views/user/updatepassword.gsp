				...
				<div class="box-body">
					<g:form method="post">
						...
						<fieldset class="form">
							<div
								...
								<dl class="dl-horizontal">
									<dt>
										<label for="password"> 原密码： <span class="required-indicator">*</span>
										</label>
									</dt>
									<dd>
										<div class="col-xs-3">
						...
						<fieldset class="buttons">
							<g:actionSubmit class="save btn btn-primary" action="changePassWord" controller="User" value="修改" />
						</fieldset>
					</g:form>
				</div>
			</div>
